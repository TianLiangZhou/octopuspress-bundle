...
export type ControlType = 'date' | 'input' | 'textarea' | 'file' | 'image' | 'video' | 'audio' | 'select' | 'checkbox' | 'radio' | 'datetime' | 'range_date' | 'autocomplete' | 'editor' | 'color' | 'switch' | 'custom' | 'group';
